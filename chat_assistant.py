...
for more detail.
- If a question has several distinct parts (e.g. asking about money, growth, happiness, \
...
def ask_gemini(api_key: str, system_prompt: str, chat_history: list, model: str = "gemini-3.6-flash") -> str:
    """
